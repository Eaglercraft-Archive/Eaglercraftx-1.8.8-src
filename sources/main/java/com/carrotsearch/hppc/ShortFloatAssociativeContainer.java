...
public interface ShortFloatAssociativeContainer extends Iterable<ShortFloatCursor> {
   ...
   * subclass of {@link ShortFloatProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ShortFloatPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
