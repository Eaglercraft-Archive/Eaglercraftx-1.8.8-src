...
/**
 * Read-only view with sorted iteration order on a delegate {@link IntDoubleHashMap}.
 *
 ...
 * another {@link IntDoubleHashMap} as this may result in a runtime deadlock. See <a
...
public class SortedIterationIntDoubleHashMap implements IntDoubleMap {
   ...
   */
  public SortedIterationIntDoubleHashMap(
      IntDoubleHashMap delegate, IntDoubleComparator comparator) {
    this.delegate = delegate;
    this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
  }
