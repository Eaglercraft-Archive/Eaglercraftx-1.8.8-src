...
/**
 * Read-only view with sorted iteration order on a delegate {@link ShortByteHashMap}.
 *
 ...
 * another {@link ShortByteHashMap} as this may result in a runtime deadlock. See <a
...
public class SortedIterationShortByteHashMap implements ShortByteMap {
   ...
   */
  public SortedIterationShortByteHashMap(
      ShortByteHashMap delegate, ShortByteComparator comparator) {
    this.delegate = delegate;
    this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
  }
