...
public interface ObjectContainer<KType> extends Iterable<ObjectCursor<KType>> {
  ...
  /**
   * Copies all elements of this container to a dynamically created array of the given component
   * type.
   *
   * @throws ArrayStoreException Thrown if this container's elements are not assignable to the
   ...
   * of {@link ObjectProcedure}. This lets the caller to call methods of the argument by chaining
