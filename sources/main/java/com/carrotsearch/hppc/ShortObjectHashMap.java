...
/**
 * A hash map of <code>short</code> to <code>Object</code>, implemented using open addressing with
...
public class ShortObjectHashMap<VType>
    implements ShortObjectMap<VType>, Preallocable, Cloneable, Accountable {
  ...
  /**
   * Return true if all keys of some other container exist in this container. Values are compared
   * using {@link Objects#equals(Object)} method.
   */
