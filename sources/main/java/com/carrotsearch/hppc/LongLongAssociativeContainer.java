...
public interface LongLongAssociativeContainer extends Iterable<LongLongCursor> {
   ...
   * subclass of {@link LongLongProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link LongLongPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
