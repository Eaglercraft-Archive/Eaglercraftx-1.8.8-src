...
public interface IntShortAssociativeContainer extends Iterable<IntShortCursor> {
   ...
   * subclass of {@link IntShortProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link IntShortPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
