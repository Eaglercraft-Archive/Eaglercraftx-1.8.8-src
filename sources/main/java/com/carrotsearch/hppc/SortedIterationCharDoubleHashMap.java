...
/**
 * Read-only view with sorted iteration order on a delegate {@link CharDoubleHashMap}.
 *
 ...
 * another {@link CharDoubleHashMap} as this may result in a runtime deadlock. See <a
...
public class SortedIterationCharDoubleHashMap implements CharDoubleMap {
   ...
   */
  public SortedIterationCharDoubleHashMap(
      CharDoubleHashMap delegate, CharDoubleComparator comparator) {
    this.delegate = delegate;
    this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
  }
