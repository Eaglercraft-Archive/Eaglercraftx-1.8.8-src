...
/**
 * Read-only view with sorted iteration order on a delegate {@link IntCharHashMap}.
 *
 ...
 * another {@link IntCharHashMap} as this may result in a runtime deadlock. See <a
