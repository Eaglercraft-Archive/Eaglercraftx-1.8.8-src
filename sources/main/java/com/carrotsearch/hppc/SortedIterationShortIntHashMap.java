...
/**
 * Read-only view with sorted iteration order on a delegate {@link ShortIntHashMap}.
 *
 ...
 * another {@link ShortIntHashMap} as this may result in a runtime deadlock. See <a
