...
public class IntPgmIndex implements Accountable {
  ...
  public static final int KEY_SIZE =
      RamUsageEstimator.primitiveSizes.get(int.class) / Integer.BYTES;
  ...
  public static class IntBuilder implements PlaModel.SegmentConsumer, Accountable {
    ...
    /** Builds the {@link IntPgmIndex}; or {@link #EMPTY} if there are no keys in the list. */
