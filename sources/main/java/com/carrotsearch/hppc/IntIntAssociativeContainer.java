...
public interface IntIntAssociativeContainer extends Iterable<IntIntCursor> {
   ...
   * subclass of {@link IntIntProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link IntIntPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
