...
/**
 * Read-only view with sorted iteration order on a delegate {@link ObjectObjectHashMap}.
 *
 ...
 * another {@link ObjectObjectHashMap} as this may result in a runtime deadlock. See <a
...
public class SortedIterationObjectObjectHashMap<KType, VType>
   ...
   */
  public SortedIterationObjectObjectHashMap(
      ObjectObjectHashMap<KType, VType> delegate, Comparator<KType> comparator) {
   ...
   */
  public SortedIterationObjectObjectHashMap(
      ObjectObjectHashMap<KType, VType> delegate, ObjectObjectComparator<KType, VType> comparator) {
    this.delegate = delegate;
    this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
  }
  ...
  protected int[] sortIterationOrder(
      int[] entryIndexes, ObjectObjectComparator<KType, VType> comparator) {
    QuickSort.sort(
        entryIndexes,
  ...
  private final class KeysContainer extends AbstractObjectCollection<KType>
    ...
    private final SortedIterationObjectObjectHashMap<KType, VType> owner =
        SortedIterationObjectObjectHashMap.this;
