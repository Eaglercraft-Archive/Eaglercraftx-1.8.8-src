...
public interface LongShortAssociativeContainer extends Iterable<LongShortCursor> {
   ...
   * subclass of {@link LongShortProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link LongShortPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
