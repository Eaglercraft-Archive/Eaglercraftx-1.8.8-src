...
public interface ShortObjectAssociativeContainer<VType> extends Iterable<ShortObjectCursor<VType>> {
   ...
   * subclass of {@link ShortObjectProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ShortObjectPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
