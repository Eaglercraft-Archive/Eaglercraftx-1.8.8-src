...
public interface ObjectCharAssociativeContainer<KType> extends Iterable<ObjectCharCursor<KType>> {
   ...
   * subclass of {@link ObjectCharProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ObjectCharPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
