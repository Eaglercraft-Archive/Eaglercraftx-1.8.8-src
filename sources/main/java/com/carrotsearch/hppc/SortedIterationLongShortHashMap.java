...
/**
 * Read-only view with sorted iteration order on a delegate {@link LongShortHashMap}.
 *
 ...
 * another {@link LongShortHashMap} as this may result in a runtime deadlock. See <a
...
public class SortedIterationLongShortHashMap implements LongShortMap {
   ...
   */
  public SortedIterationLongShortHashMap(
      LongShortHashMap delegate, LongShortComparator comparator) {
    this.delegate = delegate;
    this.iterationOrder = sortIterationOrder(createEntryIndexes(), comparator);
  }
