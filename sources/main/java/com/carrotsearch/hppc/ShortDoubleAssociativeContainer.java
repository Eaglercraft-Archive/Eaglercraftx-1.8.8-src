...
public interface ShortDoubleAssociativeContainer extends Iterable<ShortDoubleCursor> {
   ...
   * subclass of {@link ShortDoubleProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ShortDoublePredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
