...
public interface ObjectByteAssociativeContainer<KType> extends Iterable<ObjectByteCursor<KType>> {
   ...
   * subclass of {@link ObjectByteProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ObjectBytePredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
