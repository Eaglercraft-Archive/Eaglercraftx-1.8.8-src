...
public interface IntLongAssociativeContainer extends Iterable<IntLongCursor> {
   ...
   * subclass of {@link IntLongProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link IntLongPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
