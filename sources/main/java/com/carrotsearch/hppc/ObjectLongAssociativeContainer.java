...
public interface ObjectLongAssociativeContainer<KType> extends Iterable<ObjectLongCursor<KType>> {
   ...
   * subclass of {@link ObjectLongProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ObjectLongPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
