...
public interface ObjectIntAssociativeContainer<KType> extends Iterable<ObjectIntCursor<KType>> {
   ...
   * subclass of {@link ObjectIntProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ObjectIntPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
