...
public interface ShortCharAssociativeContainer extends Iterable<ShortCharCursor> {
   ...
   * subclass of {@link ShortCharProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ShortCharPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
