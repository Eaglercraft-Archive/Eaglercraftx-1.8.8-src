...
public interface ObjectDoubleAssociativeContainer<KType>
   ...
   * subclass of {@link ObjectDoubleProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ObjectDoublePredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
