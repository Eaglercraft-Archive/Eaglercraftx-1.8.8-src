...
public interface LongCharAssociativeContainer extends Iterable<LongCharCursor> {
   ...
   * subclass of {@link LongCharProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link LongCharPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
