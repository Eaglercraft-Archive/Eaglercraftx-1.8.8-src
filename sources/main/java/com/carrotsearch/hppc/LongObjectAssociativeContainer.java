...
public interface LongObjectAssociativeContainer<VType> extends Iterable<LongObjectCursor<VType>> {
   ...
   * subclass of {@link LongObjectProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link LongObjectPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
