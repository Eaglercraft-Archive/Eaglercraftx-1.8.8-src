...
public interface LongByteAssociativeContainer extends Iterable<LongByteCursor> {
   ...
   * subclass of {@link LongByteProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link LongBytePredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
