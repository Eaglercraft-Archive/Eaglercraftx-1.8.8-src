...
public interface ObjectObjectAssociativeContainer<KType, VType>
   ...
   * subclass of {@link ObjectObjectProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ObjectObjectPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
