...
public interface ShortLongAssociativeContainer extends Iterable<ShortLongCursor> {
   ...
   * subclass of {@link ShortLongProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ShortLongPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
