...
public interface LongDoubleAssociativeContainer extends Iterable<LongDoubleCursor> {
   ...
   * subclass of {@link LongDoubleProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link LongDoublePredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
