...
public interface LongFloatAssociativeContainer extends Iterable<LongFloatCursor> {
   ...
   * subclass of {@link LongFloatProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link LongFloatPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
