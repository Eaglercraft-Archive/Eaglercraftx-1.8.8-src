...
public interface ShortByteAssociativeContainer extends Iterable<ShortByteCursor> {
   ...
   * subclass of {@link ShortByteProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ShortBytePredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
