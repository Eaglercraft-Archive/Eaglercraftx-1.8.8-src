...
public interface ShortShortAssociativeContainer extends Iterable<ShortShortCursor> {
   ...
   * subclass of {@link ShortShortProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ShortShortPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
