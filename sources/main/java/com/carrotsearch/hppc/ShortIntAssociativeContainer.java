...
public interface ShortIntAssociativeContainer extends Iterable<ShortIntCursor> {
   ...
   * subclass of {@link ShortIntProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ShortIntPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
