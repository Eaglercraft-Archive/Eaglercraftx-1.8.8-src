...
public interface IntObjectAssociativeContainer<VType> extends Iterable<IntObjectCursor<VType>> {
   ...
   * subclass of {@link IntObjectProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link IntObjectPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
