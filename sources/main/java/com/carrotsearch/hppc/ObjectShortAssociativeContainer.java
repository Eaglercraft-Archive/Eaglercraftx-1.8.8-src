...
public interface ObjectShortAssociativeContainer<KType> extends Iterable<ObjectShortCursor<KType>> {
   ...
   * subclass of {@link ObjectShortProcedure}. This lets the caller call methods of the argument by
   ...
   * subclass of {@link ObjectShortPredicate}. This lets the caller call methods of the argument by
   * chaining the call (even if the argument is an anonymous type) to retrieve computed values.
   *
